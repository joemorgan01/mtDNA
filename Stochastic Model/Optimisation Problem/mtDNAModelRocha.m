function [tplot, Yplot, COXDef] = mtDNAModelRocha ( Y0, timeSamples, C0, Parameters)
...
%     if e>0 || abs(e)>(0.05*Parameters(1))
%         Kc=Parameters(4);  % For SP Tracking
% %        Kc=2e-11; % For Disturbance Rejeciton
%         MV=e*Kc;
%     else
%         MV=0;
%     end
